...
prefer the printed page together with publication identity; a PDF page number
may also be recorded as a local navigation aid.
...
| --- | ---: | --- | --- |
| 2-3 | — | Engine harness layout for 1HZ and 1PZ | Printed page confirmed; PDF page unmapped |
| 2-6 | — | Harness-layout component index associated with the instrument-panel section | Printed page confirmed; PDF page unmapped |
| 5-2 | — | Component-name index | Printed page confirmed; PDF page unmapped |

## Reviewed Locations Without Confirmed Printed Pages

- Title and applicability page — printed page and PDF page not confirmed.
- Manual-organization page — printed page and PDF page not confirmed.

These locations must remain unmapped until verified against the local artifact.
