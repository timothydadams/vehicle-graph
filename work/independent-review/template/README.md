# Independent Review Package Template

Copy this directory to `work/independent-review/<review-id>/` and replace every
angle-bracket placeholder. Do not use the template directory itself as a live
review package.
